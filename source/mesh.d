...
struct UMesh2
{
	...
	@nogc Vector!2 computeBoundaryForces(string[] tags)
	{
		...
		MPI_Reduce(f[].ptr, globalF[].ptr, 2, MPI_DOUBLE, MPI_SUM, 0, comm);

		return globalF;
	}
}

idxtype[] buildPartitionMap(ref UMesh2 bigMesh, uint p, uint id, MPI_Comm comm, double[] partWeights)
{
